...
namespace Microsoft.AspNetCore.Server.Kestrel
{
    ...
    public class KestrelThread
    {
        ...
        private readonly AsyncNetworkHost _host;
        ...
        public KestrelThread(AsyncNetworkHost host)
        {
            _host = host;
            _log = host.Log;
            _threadPool = host.ThreadPool;
            _loop = new UvLoopHandle() { Log = _log };
            _post = new UvAsyncHandle() { Log = _log };
            ...
            if (_thread.IsAlive)
            {
                ...
                try
                {
                    ...
                    if (!_thread.Join(stepTimeout))
                    {
                        ...
                        if (!_thread.Join(stepTimeout))
                        {
                            _log.Error(0, "KestrelThread.Stop failed to terminate libuv thread.", null);
                        }
                    }
                }
        ...
        private void ThreadStart(object parameter)
        {
            ...
            catch (Exception ex)
            {
                ...
                _host._appLifetime.StopApplication();
            }
        }
        ...
        private bool DoPostWork()
        {
            ...
            while (queue.Count != 0)
            {
                ...
                catch (Exception ex)
                {
                    ...
                    {
                        _log.Error(0, "KestrelThread.DoPostWork", ex);
                        throw;
                    }
                }
            }
        ...
        private bool DoPostCloseHandle()
        {
            ...
            while (queue.Count != 0)
            {
                ...
                {
                    _log.Error(0, "KestrelThread.DoPostCloseHandle", ex);
                    throw;
                }
            }
